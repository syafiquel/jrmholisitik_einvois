                         ...
                         <td class="text-center">
                           <ul class="list-inline me-auto mb-0">
                             ...
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                               <!-- <a href="edit_product.php?id=<?php echo $row['id'] ?>" data-bs-toggle="offcanvas" data-bs-target="#edit-product-form-<?php echo $row['id'];?>" class="avtar avtar-xs btn-link-success btn-pc-default"> -->
                               <a href="edit_product.php?id=<?php echo $row['id'] ?>" class="avtar avtar-xs btn-link-success btn-pc-default">
                                 <i class="ti ti-edit-circle f-18"></i>
                               </a>
                             </li>
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Delete">
                               <form id="form_product<?php echo $row['id'];?>" method="post" enctype="multipart/form-data" >
