        ...
        <div class="col-sm-12">
          <div class="d-print-none card mb-3">
            <div class="card-body p-3">
              <!-- <span class="">INV-000457</span> -->
              <ul class="list-inline ms-auto mb-0 d-flex justify-content-end flex-wrap">
                <li class="list-inline-item align-bottom me-2">
                  <a href="print_do.php?ids=<?php echo $order['id'] ?>" target="_blank" class="avtar avtar-s btn-link-secondary">
                    <i class="ph-duotone ph-printer f-22"></i>
                  </a>
                </li>
                <li class="list-inline-item align-bottom me-2">
                  <a href="#" data-bs-toggle='modal' data-bs-target="#modal_copy" class="avtar avtar-s btn-link-secondary">
    ...
    <div class="modal-dialog  modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="">
            <b>Invoice Link</b>
            <input type="text" class="form-control disabled" id="invoice_link_input" name="" value="https://app.jrmholistikampang.com/inv.php?id=<?php echo $order['id'] ?>">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" onclick="copyToClipboard('invoice_link_input')">Copy</button>
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
