                   ...
                   <table class="table table-hover " id="table-orders">
                     <thead>
                       ...
                       <tr>
                         ...
                         <th class="text-center">Picking Time</th>
           ...
           <div class="modal-dialog modal-dialog-centered " role="document">
             <div class="modal-content">
               <div class="modal-header">
                 <h5 class="modal-title">Pick Up Order</h5>
               ...
               <form method="post" >
                 <div class="modal-body">
                   ...
                   <div class="form-group">
                     <div class="text-center">
                       Pick Up By:
                       <br>
                       <h4 id="pickup_name">Pickup Person</h4>
                       <h5 id="pickup_phone">Pickup phone</h5>
                       <br>
                       at <span id="pickup_send_at"></span>
                     </div>
                   </div>
                 ...
                 <div class="modal-footer">
                   ...
                   <button type="submit" class="btn btn-sm btn-primary" name="update_order_status">Order Picked Up</button>
                 </div>
               </form>
             </div>
           </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.30.1/moment.min.js"
   ...
   <script>
    ...
    var tableOrder = $('#table-orders').on('init.dt', function () {
      ...
      serverSide: true,
      ajax: {
        url: '../shared/orders/get_orders.php?status=paid&type=to_pickup',
        type: 'POST'
      },
      pageLength: 10,
      lengthMenu: [
      ...
      columns: [
        {
          ...
          render: function(data, type, row, meta) {
            ...
            if (type === 'display') {
              return `${row.send_to}<br>${row.send_at}`; // Format as currency
            }
              ...
              return `<ul class="list-inline me-auto mb-0">
                         ...
                         <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Update Status">
                           <a
                             href="#"
                             class="avtar avtar-xs btn-link-secondary btn-pc-default"
                             onclick="openPickupForm('${row.id}','${row.pickup_name}', '${row.pickup_phone}', '${row.send_at}')"
                           >
    ...
    function openPickupForm(id, name, phone, send_at) {
      $("#pickup_name").text(name)
      $("#pickup_phone").text(phone)
      $("#pickup_send_at").text(send_at)
      $("#order_id").val(id)
