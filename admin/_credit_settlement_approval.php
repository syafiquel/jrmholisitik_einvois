...
$page_name = "Credit Terms Outstanding";
...
if (isset($_POST['approve_payment'])) {
  ...
  $sql = "UPDATE credit_terms SET status = '$outstanding_status' , payment_approval_status = $approval_status WHERE id = $id";
...
$sql = "SELECT *, ct.id as id FROM credit_terms ct
 RIGHT JOIN user usr
 ON usr.id = ct.user_id
 WHERE ct.status = 'outstanding'
 ...
 <body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="<?php echo $main_orientation ?>" data-pc-direction="ltr" data-pc-theme_contrast="" data-pc-theme="light">
                      ...
                      ?>
                       <tr>
                         ...
                         <td class="text-center">
                           <a class="text-primary" href="view_order.php?id=<?php echo $row['order_id'] ?>">
                         ...
                         <td class="text-center">
                           <ul class="list-inline me-auto mb-0">
                             ...
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Outstanding #<?php echo $row['id'] ?>">
                               <a href="#" onclick="viewSettlement('<?php echo $row['nama'] ?>','<?php echo $row['id'] ?>','<?php echo $row['resit_file'] ?>','<?php echo $row['datetime_transfer'] ?>','<?php echo $row['outstanding_amount'] ?>')" class="avtar avtar-xs btn-link-success btn-pc-default">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfobject/2.1.1/pdfobject.min.js"></script>
   ...
   <script>
     ...
     function viewSettlement(nama, id, resit_file, date_time_transfer, amount) {
