...
$sql = "SELECT * FROM user
 WHERE credit_used > 0 ORDER BY id DESC ";
                     ...
                     <?php
                      ...
                      // $i = 0+($paginator->currentPage-1)*$paginator->itemsPerPage;
                        ...
                        while($row = $result_c->fetch_assoc()) {
                          $i++;
                          $credit_limit = $row['credit_limit'] > 0 ? $row['credit_limit'] : $credit_main_setting['limit_total_price'];
$whatsappText = "{$row['nama']} - Outstanding ".Helper::MYR($row['credit_used']) ."
Sila jelaskan bayaran tertunggak untuk mengelakkan kesulitan di masa akan datang";
                      ?>
                       <tr>
                         ...
                         <td class="text-end"><?php echo Helper::MYR($row['credit_used']) ?></td>
                         <td class="text-end"><?php echo Helper::MYR($credit_limit) ?></td>
                         <td class="text-center">
                           <ul class="list-inline me-auto mb-0">
                             <!-- <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Whatsapp">
                               <a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo Helper::sanitizePhone($row['no_tel']) ?>&text=<?php echo urlencode(trim($whatsappText)); ?>" class="avtar avtar-xs btn-link-success btn-pc-default">
                               <a target="_blank" href="https://wa.me/<?php echo Helper::sanitizePhone($row['no_tel']) ?>?text=<?php echo urlencode(trim($whatsappText)); ?>" class="avtar avtar-xs btn-link-success btn-pc-default">
                                 <i class="ti ti-phone-call f-18"></i>
                               </a>
                             </li> -->
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Whatsapp Skrip">
                               <a href="#" data-bs-toggle="modal" data-bs-target="#credit-action-<?php echo $row['id'];?>" class="avtar avtar-xs btn-link-success btn-pc-default">
                                 <i class="ti ti-phone-call f-18"></i>
                               </a>
                             </li>
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                               <a href="#" data-bs-toggle="modal" data-bs-target="#whatsapp-text-<?php echo $row['id'];?>" class="avtar avtar-xs btn-link-success btn-pc-default">
                           ...
                           <div class="modal-dialog modal-dialog-centered " role="document">
                             <div class="modal-content">
                               <div class="modal-header">
                                 <h5 class="modal-title">Whatsapp Skrip</h5>
                               ...
                               <form id="admin_pengguna_form" name="admin_pengguna_form" role="form" method="post" onsubmit=""  enctype="multipart/form-data" >
                                 <div class="modal-body">
                                   ...
                                   <div class="form-group">
                                     <textarea name="name" class="form-control"  rows="5" cols="80"><?php echo $whatsappText ?></textarea>
                                   </div>
                         ...
                         <div class="modal fade " id="whatsapp-text-<?php echo $row['id'];?>" tabindex="-1" role="dialog"
                           aria-labelledby="exampleModalRight" aria-hidden="true" style=" overflow-y: scroll;">
                           <div class="modal-dialog modal-dialog-centered " role="document">
                             <div class="modal-content">
                               <div class="modal-header">
                               ...
                               <form id="admin_pengguna_form" name="admin_pengguna_form" role="form" method="post" onsubmit=""  enctype="multipart/form-data" >
                                 <div class="modal-body">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <br>
                                     Balance: <b><?php echo $row['credit_used'] ?></b>
                                     <br>
                                     <hr>
  ...
  <script src="../assets/js/plugins/sweetalert2.all.min.js"></script>
   ...
   <script>
     ...
     function copyText() {
       var textarea = document.getElementById("whatsappText");
       textarea.select();
