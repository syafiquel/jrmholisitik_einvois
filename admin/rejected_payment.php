...
$page_name = "Payment Rejected Orders";
$url = "rejected_payment.php";
...
if (isset($_POST['approve_payment'])) {
  ...
  if ($status == 'approve') {
    ...
    $approval = "isRejected =  now(), cancel_reason = '$cancel_note'";
  }
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.30.1/moment.min.js"
   ...
   <script>
    ...
    var tableOrder = $('#table-orders').on('init.dt', function () {
      ...
      serverSide: true,
      ajax: {
        url: '../shared/orders/get_orders_for_approval.php?pending=1',
        type: 'POST'
      },
      pageLength: 10,
      lengthMenu: [
