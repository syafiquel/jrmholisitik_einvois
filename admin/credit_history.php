...
$sql = "SELECT *, ct.status as status, ct.created_at as created_at  FROM credit_terms ct
 JOIN user usr
                       ...
                       <tr>
                         ...
                         <td class="text-center">
                           <ul class="list-inline me-auto mb-0">
                             ...
                             <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="<?php echo strtoupper($row['status']) ?>">
                               <?php if ($row['status'] == 'outstanding'): ?>
