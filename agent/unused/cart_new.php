...
if (isset($_POST['making_payment'])) {
  ...
  if ($_POST['payment_method'] === 'billplz') {
    ...
    if ($credit_available) {
      ...
      $result = Order::payWithCreditTerm($order_id);
      if ($result['status'] == 'success') {
        ...
        $_SESSION['error'] = "Payment failed: " . $result['message'];
    ...
    if(isset($_FILES['resit_file']) && $_FILES['resit_file']['size'] > 0){
      ...
      // Check stock availability before processing bank transfer
              ...
              <div class="row">
                ...
                <div class="col-xl-4">
                  ...
                  <div class="d-grid mb-3">
                    <button class="btn btn-primary" onClick="change_tab('#ecomtab-2')">Proceed to Delivery</button>
                  </div>
                </div>
              </div>
            </div>
...
<script src="../assets/js/plugins/datepicker-full.min.js"></script>
  ...
  var mp3_url = 'https://media.geeksforgeeks.org/wp-content/uploads/20190531135120/beep.mp3';
    ...
    function increaseValue(counter) {
      ...
      value++;
      calculateOrderProduct(op_id, value)
    ...
    // quantity en
    function calculateOrderProduct(op_id, new_qty) {
