    ...
    <div class="pc-content">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h4 class="mb-0"><?php echo date('d M Y, D') ?></h4>
                <h4 class="mb-0">Hi <?php echo Helper::shortName($user['nama']) ?></h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <?php if (! $credit_available): ?>
          <div class="col-12">
            <div class="card welcome-banner bg-red-800">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-7">
                    <div class="p-4">
                      <h2 class="text-white">Your have outstanding payment</h2>
                      <p class="text-white">Your credit term option for payment has been lock.</p>
                      <a href="pay_outstanding.php" class="btn btn-outline-light ">Pay outstanding</a>
                    </div>
                  </div>
                  <div class="col-sm-5 text-center">
                    <div class="img-welcome-banner">
                      <img src="../assets/images/lock-3d.png" alt="img" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <div class="avtar avtar-s bg-light-danger">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#DC2626" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-grid mt-3">
                <button class="btn btn-primary d-flex align-items-center justify-content-center gap-2"><i class="ti ti-plus"></i> Add task</button>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="mt-3 d-grid">
                    <button class="btn btn-primary d-flex align-items-center justify-content-center gap-2"><i class="ti ti-plus"></i> Add project</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body border-bottom pb-0">
              ...
              <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="analytics-tab-1" data-bs-toggle="tab" data-bs-target="#analytics-tab-1-pane" type="button" role="tab" aria-controls="analytics-tab-1-pane" aria-selected="true">All Transaction</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="analytics-tab-2" data-bs-toggle="tab" data-bs-target="#analytics-tab-2-pane" type="button" role="tab" aria-controls="analytics-tab-2-pane" aria-selected="false">Success</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="analytics-tab-3" data-bs-toggle="tab" data-bs-target="#analytics-tab-3-pane" type="button" role="tab" aria-controls="analytics-tab-3-pane" aria-selected="false">Pending</button>
                </li>
              </ul>
            </div>
